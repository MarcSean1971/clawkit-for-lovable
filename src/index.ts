...
type WorkflowState = {
  projectName: string;
  mode: "new-build" | "rescue" | "improve" | "harden" | "ship" | "unknown";
  sourceOfTruth: "lovable.dev" | "github" | "local-repo" | "deployed-app" | "unknown";
  appStatus: "idea" | "generated" | "broken" | "invisible-change" | "needs-refactor" | "ready-for-verification" | "ready-for-pr";
...
type StudioBrain = {
  projectName: string;
  mode: "start" | "rescue" | "improve" | "harden" | "ship" | "orient-user";
