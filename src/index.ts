...
function detectFrameworks(repoPath: string, pkg: PackageJson | null): string[] {
...
function readGitFile(repoPath: string, relativePath: string): string {
  try {
...
async function inspectRepo(repoPathInput: string): Promise<RepoDoctor> {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    api.registerTool({
      ...
      description:
        "Inspect a local Lovable/GitHub repository and report framework signals, Git state, Lovable commit signals, recommended verification commands, and next action.",
      parameters: Type.Object({
